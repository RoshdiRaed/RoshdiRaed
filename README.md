...
| :hash: | Project | Description | Repo Link |
|:--------:|---------|-------------|-----------|
| :one: | [Renewable Energy Access in India](https://github.com/prathimacode-hub/Increasing-Renewable-Energy-Access-India)| <br> <br> This project focuses on increasing renewable energy access in India using AI. <br> | [@prathimacode-hub/Increasing-Renewable-Energy-Access-India](https://github.com/prathimacode-hub/Increasing-Renewable-Energy-Access-India) |
| :two: | [AI for Road Safety in India](https://github.com/prathimacode-hub/AI-For-Road-Safety)| <br> <br>AI for Road Safety helps in overcoming accidental challenges using body language and past accidental data. <br> | [@prathimacode-hub/AI-For-Road-Safety](https://github.com/prathimacode-hub/AI-For-Road-Safety) |
| :three: | [Water Quality Monitoring Dashboard](https://github.com/prathimacode-hub/Water-Quality-Monitoring)| <br>  <br>Water Quality Monitoring Dashboard for Kutch region that visualizes the parameters to determine the water quality according to the standards.<br> | [@prathimacode-hub/Water-Quality-Monitoring](https://github.com/prathimacode-hub/Water-Quality-Monitoring) |
| :four: | [Nakagwawa Safest Path during Earthquakes](https://github.com/prathimacode-hub/Nakagawa--Safest_Path_During_Earthquakes)| <br> <br>An Interactive WebApp to devise safest path in Nakagawa-Ku region, Japan during natural disasters like Earthquakes, Tsunamis and Floods that helps in prioritizing the citizen's safety in risk prone zones.<br> | [@prathimacode-hub/Nakagawa--Safest_Path_During_Earthquakes](https://github.com/prathimacode-hub/Nakagawa--Safest_Path_During_Earthquakes) |
...
| :five: | [PyAlgo-Tree](https://github.com/prathimacode-hub/PyAlgo-Tree)| <br> This project aims to be a finest hub of various data structures and algorithms you need to know in python across different topics and fields. <br><br> | [@prathimacode-hub/PyAlgo-Tree](https://github.com/prathimacode-hub/PyAlgo-Tree) |
